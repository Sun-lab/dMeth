...
#Yexpr  = fread('~/Hutch-Research/Data/Real/cleaned_expression_LUSC_data.txt')
...
#icedt_LUSC = ICeDT(Y=as.matrix(Yexpr),Z=muexpr, tumorPurity = eta, refVar = NULL)
...
#save(icedt_LUSC, file = 'icedt_LUSC.RData')
