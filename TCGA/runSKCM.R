...
#Yexpr  = fread('~/Hutch-Research/Data/Real/cleaned_expression_SKCM_data.txt')
...
#icedt_SKCM = ICeDT(Y=as.matrix(Yexpr),Z=muexpr, tumorPurity = eta, refVar = NULL)
...
#save(icedt_SKCM, file = 'icedt_SKCM.RData')
