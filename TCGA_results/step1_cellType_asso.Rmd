...
```{r warning = FALSE, message = FALSE, fig.height=7.5, fig.width=4.5}
ctypes = c("CD4T.E", "CD4T", "CD8T.E", "CD8T", "Treg.E", "Treg")
gl = list()
for(ct1 in ctypes){
...
ggarrange(gl[[1]], gl[[2]], gl[[3]], gl[[4]], gl[[5]], gl[[6]], nrow = 3, ncol = 2)
```
